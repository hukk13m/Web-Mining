...
# Xuất file CSV
hourly_dataframe.to_csv("DN_hourly.csv", index=False, encoding="utf-8-sig")
daily_dataframe.to_csv("DN_daily.csv", index=False, encoding="utf-8-sig")

# Xuất file Excel
try:
    hourly_dataframe.to_excel("DN_hourly.xlsx", index=False)
    daily_dataframe.to_excel("DN_daily.xlsx", index=False)
